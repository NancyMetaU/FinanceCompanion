...
const FeatureCard = ({ title, path, desc, icon, color, delay }) => (
  <Link to={path} className={`group animate-fade-in-up ${delay}`}>
    <Card
      className="relative h-full flex flex-col items-center text-center pt-6
                 pb-8 px-6 hover:shadow-xl transition-all duration-300 cursor-pointer
